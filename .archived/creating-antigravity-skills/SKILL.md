...
description: Creates new skills for the Antigravity agent. Use when the user wants to generate, build, or create a new skill to extend the agent's capabilities.
---
...
- User asks to build a skill
- User references "skill creator" or "Gemini skill creator"
